...
function Get-SddcDiagnosticInfo
{
    ...
    try {
        ...
        if ($AccessNode) {
            ...
            $JobStatic += Invoke-SddcCommonCommand -ClusterNodes $AccessNode -JobName ClusterGroup {$CommonFunc;
                try {
            ...
            $JobStatic += Invoke-SddcCommonCommand -ClusterNodes $AccessNode -JobName ClusterNetwork {$CommonFunc;
                try {
            ...
            $JobStatic += Invoke-SddcCommonCommand -ClusterNodes $AccessNode -JobName ClusterResource {$CommonFunc;
                try {
            ...
            $JobStatic += Invoke-SddcCommonCommand -ClusterNodes $AccessNode -JobName ClusterResourceParameter {$CommonFunc;
                try {
            ...
            $JobStatic += Invoke-SddcCommonCommand -ClusterNodes $AccessNode -JobName ClusterSharedVolume {$CommonFunc;
                try {
        ...
        $JobCopyOut += Invoke-SddcCommonCommand -ClusterNodes $($ClusterNodes).Name -JobName Verifier {$CommonFunc;
        ...
        $JobCopyOut += Invoke-SddcCommonCommand -ClusterNodes $($ClusterNodes).Name -JobName 'Filesystem Filter Manager' {$CommonFunc;
        ...
        $JobStatic += $($ClusterNodes).Name |% {
            ...
            Invoke-SddcCommonCommand -ClusterNodes $AccessNode -JobName "System Info: $_" -ArgumentList $_,$ClusterDomain,$AccessNode,$Path {

                param($NodeName,$DomainName,$AccessNode,$Path)
                ...
                SystemInfo.exe /S $Node > (Join-Path (Get-NodePath $Path $NodeName) "SystemInfo.TXT")
